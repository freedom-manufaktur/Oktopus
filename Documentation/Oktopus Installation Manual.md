...
---
Version: `5.18.0` - `2024-10-17` \
Author: oktopus@freedom-manufaktur.com \
...
2. *(Optional, when offline*) Download and install the most recent [.NET 8.0 Runtimes](https://dotnet.microsoft.com/en-us/download/dotnet/8.0)
   1. ASP.NET Core Runtime x64 Installer
   2. .NET Desktop Runtime x64 Installer

3. Install `whoosh Oktopus Server Setup 5.17.0.exe`
...
2.  [Contact us](oktopus@freedom-manufaktur.com) to help you with the installation.
...
# Need support?
If you have any questions regarding the installation or configuration of *whoosh Oktopus*, contact us at oktopus@freedom-manufaktur.com (freedom manufaktur).